 ...
 * @param {function} func
 */
function addListener(el, eventString, func) {
 ...
 * @param {function} func
 */
function removeListener(el, eventString, func) {
    var events = eventString.split(" ");
    for(var i = 0; i < events.length; i++) {
        var event = events[i];
            ...
            link: function (scope, element, attrs) {
                ...
                var onpress = function(evt) {
                    ...
                    if(_hasTouch){
                        ...
                        addListener(document, _moveEvents, cancelPress);
                        //$document.on(_releaseEvents, cancelPress);
                        addListener(document, _releaseEvents, cancelPress);
                ...
                var cancelPress = function() {
                    ...
                    removeListener(document, _moveEvents, cancelPress);
                ...
                var onlongpress = function(evt) {
                    ...
                    offset = rect;
                    element.centerX = (rect.width/2);
                    element.centerY = (rect.height/2);
                    ...
                    if (_centerAnchor) {
                        _tx = _mx - element.centerX - window.scrollX;
                        _ty = _my - element.centerY - window.scrollY;
                    } else {
                        _tx = offset.left - window.scrollX;
                        _ty = offset.top - window.scrollY;
                    }
                ...
                var onmove = function(evt) {
                    ...
                    if (_centerAnchor) {
                        ...
                        _tx = _mx - _mrx - window.scrollX;
                        _ty = _my - _mry - window.scrollY;
                    }
